...
function Set-AvmGitHubPrLabels {
  ...
  $teamNames = [array](Get-GithubPrRequestedReviewerTeamNames -PrUrl $PrUrl.Replace('api.', '').Replace('repos/', '') | Where-Object { $_ -ne 'bice-admins' -and $_ -ne 'avm-core-team-technical-bicep' })
